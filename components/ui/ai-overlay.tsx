          ...
          <div className="flex items-center gap-2">
            {onRegenerate && (
              <button
                ...
                className="flex items-center gap-2 rounded-lg border border-[#282b30] px-3 py-2 text-sm font-semibold text-gray-300 transition hover:bg-[var(--surface-2)] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
              >
                {isRegenerating ? (
                  <>
