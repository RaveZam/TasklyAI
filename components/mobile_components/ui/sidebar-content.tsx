    ...
    <>
      <div className="flex h-full flex-col">
        ...
        <Link
          ...
          className="flex-shrink-0 flex items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-gray-400 transition hover:bg-[var(--surface-2)] hover:text-white"
        >
          <svg
            className="h-4 w-4"
            fill="none"
