...
export function SidebarContent({ onProjectSelect }: SidebarContentProps) {
  ...
  // Get current project name for invite modal
  ...
  return (
    <>
      <div className="flex flex-col h-full">
        ...
        {/* Invite Member and Settings links - Desktop only (not shown on mobile) */}
        {!onProjectSelect && (
          <>
            {pathname === "/features/kanban" && (
              ...
              >
                <div className="relative h-4 w-4 flex items-center justify-center">
                  ...
                  <svg
                    className="absolute -bottom-0.5 -right-0.5 h-2.5 w-2.5 rounded-full bg-[var(--surface-2)] border border-[var(--background)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            <Link
              ...
              className={`flex-shrink-0 flex items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-gray-400 transition hover:bg-[var(--surface-2)] hover:text-white ${pathname === "/features/kanban" ? "" : "mt-6"}`}
            >
              <svg
                className="h-4 w-4"
                fill="none"
